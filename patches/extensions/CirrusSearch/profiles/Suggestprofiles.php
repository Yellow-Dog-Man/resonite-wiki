...
/**
 * YDMS EDITS: We changed the prefix_length to 3 in both plain_fuzzy_2 and plain_fuzzy_1
 */
...
return [
        ...
        'fuzzy' => [
                ...
                'fst' => [
                        ...
                        // Fuzzy query for query length (3 to 4) with prefix len 3
                        'plain_fuzzy_2' => [
                                'field' => 'suggest',
                                'min_query_len' => 3,
                                'max_query_len' => 4,
                        ...
                        // Fuzzy query for query length > 5 with prefix len 3
                        'plain_fuzzy_1' => [
                                'field' => 'suggest',
                                'min_query_len' => 5,
                                'discount' => 0.000001,
